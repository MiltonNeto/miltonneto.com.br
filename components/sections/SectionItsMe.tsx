                ...
                <div>
                    ...
                    <ul>
                        <li>
                            ...
                            <span name="degree">Superior</span>
                        </li>
                        <li>
                            <img alt="logo Instituição"/>
                            <h5>User Experience</h5>
                            <span className="date">Uniritter - 2018 --> 2020</span>
                            <span name="degree">Pós-graduação(Especialização)</span>
                        </li>
                        <li>
                            <img alt="logo Instituição"/>
                            <h5>Neurociências e psicologia aplicada</h5>
                            <span name="date">Mackenzie - 2022 --> 2023</span>
                            <span name="degree">Pós-graduação(Especialização)</span>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        <li>
                            <img alt="Bandeira"/>
                            <h5>Português</h5>
                            <span name="degree">Nativo</span>
                        </li>
                        <li>
                            <img alt="Bandeira"/>
                            <h5>Inglês</h5>
                            <span name="degree">Avançado</span>
                        </li>
                    </ul><li>
                            <img alt="Bandeira"/>
                            <h5>Espanhol</h5>
                            <span name="degree">Intermediário-Avançado</span>
                        </li>
                </div>
            </div>
