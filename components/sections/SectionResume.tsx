                        ...
                        <li className={styles.resumeListItem}>
                            ...
                            <Image src='/images/logos/ovni.jpg' width='30' height='30' alt="Universidade Unisul" />
                                <div className={styles.boxRight}>
                                    <h5 className={styles.JobPosition}>Consultor UX UI e Mentoria</h5>
                        ...
                        <li className={styles.resumeListItem}>
                            <div className={styles.box}>
                                ...
                                <div className={styles.boxRight}>
                                    ...
                                    <span className="date">1 ano e 9 meses</span>
                                </div>
                            </div>
                            {/*<ul className={styles.tasks}>
                        ...
                        <li className={styles.resumeListItem}>
                            <div className={styles.box}>
                                ...
                                <h4 className={styles.JobPosition}>Lead UX Designer</h4>
                                    ...
                                    <span className="date">8 meses</span>
                                </div>
                            </div>
                            {/*<ul className={styles.tasks}>
                        ...
                        <li className={styles.resumeListItem}>
                            <div className={styles.box}>
                                ...
                                <div className={styles.boxRight}>
                                    ...
                                    <span className="date">5 meses</span>
                                </div>
                            </div>
                            {/*<ul className={styles.tasks}>
                        ...
                        <li className={styles.resumeListItem}>
                            <div className={styles.box}>
                                ...
                                <div className={styles.boxRight}>
                                    ...
                                    <span className="date">1 ano e 2 meses</span>
                                </div>
                            </div>
                            {/*<ul className={styles.tasks}>
